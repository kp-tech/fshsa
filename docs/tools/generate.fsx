...
let referenceBinaries = [ "FsHsa.Okra.dll" ]
// Web site location for the generated documentation
let website = "/FsHsa"

let githubLink = "http://github.com/kp-tech/fshsa"

// Specify more information about your project
let info =
  [ "project-name", "FsHsa"
    "project-author", "Zoltan Podlovics, KP-Tech kft."
    "project-summary", "An F# binding for HSA (Heterogeneous System Architecture)"
    "project-github", githubLink
    "project-nuget", "http://nuget.com/packages/fshsa" ]
